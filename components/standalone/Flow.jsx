...
const Flow = ({ type = "ground" }) => {
  ...
  return (
    <div className="flex w-full justify-center shadow-md">
      <div className="flex flex-col w-fit justify-center items-center  py-5 px-7 rounded-lg   bg-white text-black">
        ...
        <div className="flex bigmd:flex-row flex-col gap-5">
          {lists.map((list, index) => (
            ...
            >
              <div className="bg-primary text-white rounded-full size-[40px]  flex justify-center items-center font-semibold xxs:text-[18px] text-[16px] ">
                {list.id}
              </div>
              <div className="flex flex-col w-[180px] xxxs:w-[200px] xxs:w-[210px] bxs:w-[350px] bigmd:w-[200px] mobile:w-[270px]">
                <div className="pb-2 font-semibold xxs:text-[16px] text-[14px] text-primary">
                  {type === "ground"
                    ? list.heading
                    : type === "rails"
                    ? list.headingRails
