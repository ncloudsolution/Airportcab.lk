    ...
    <div className="mt-0 mb-4" ref={loadingSectionRef}>
      ...
      {!isLoading && !responseMessage && tourDetails.trainName && (
        <div className="flex flex-col items-center">
          ...
          <div className=" rounded  bg-white shadow-xl border-primary border-2 text-black p-4 mt-10 mb-8 font-semibold gap-y-1 w-fit">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="bg-transparent xs:w-[400px] xxs:w-[300px] w-[260px] h-fit">
                    <div className="flex flex-col gap-y-1 xs:mt-10 mt-5 mb-3">
                      ...
                      {submitError && (
                        <div className="text-errorpink border-2 border-errorpink bg-white px-4 py-2 rounded mb-4 text-center mt-5">
                          {submitError}
                        </div>
                      )}
                      <div>
